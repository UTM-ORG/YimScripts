...
log.info("\n\27[4;33mScript\27[m - \27[4;37mAll Collectibles Only\27[m\nInitialized successfully.") -- By ImagineNothing
    ...
    if IsOnline then
        ...
        stats.set_packed_range(34262, 34361, true) -- LD Organics Product
        stats.set_packed_range(30230, 30239, true) -- Movie Props 
        stats.set_packed_range(26911, 26964, true) -- Playing Cards
        stats.set_packed_range(28099, 28148, true) -- Signal Jammers
